	...
	<div class="card">
		...
		<div class="stepper-container w-100">
			<div class="stepper-progress-highlight">
				<div class="default progress-bar w-100"></div>
			</div>
			<ul class="stepper-wrapper">
				<li class="step-item">
					<span class="active" @click ="navToStep(1)">
						<i class="fas fa-user"></i>
					</span>
					<p class="text-white">Profile</p>
				</li>
				<li class="step-item">
					<span class="active" @click ="navToStep(2)">
						<i class="fas fa-landmark"></i>
					</span>
					<p class="text-white">Business</p>
				</li>
				<li class="step-item">
					<span class="active" @click ="navToStep(3)">
						<i class="fas fa-users"></i>
					</span>
					<p class="text-white">Family</p>
				</li>
				<li class="step-item">
					<span class="active" @click ="navToStep(4)">
		...
		<div class="form-container">
			<form @submit.prevent="submit">
				<section class="px-2" v-if="step == 1">
					<h3 class="text-3xl mt-1 mb-8 px-3 title">Basic Information</h3>
	                ...
	                <div class="row px-3">
	                    ...
	                    <div class="form-group col-md-4 px-3">
	                        ...
	                        <input value="" id="birthplace" type="text" class="form-control" v-model="fields.birthplace" v-bind:class="hasErrors('birthplace') ? 'is-invalid' : ''" autocomplete="birthplace">
	                ...
	                <hr>
	                <h3 class="px-3 my-4 title text-3xl">Address Information</h3>
	                <div class="row px-3">
	                    <div class="form-group px-3 col-md-9">
	                        <label for="street_address">Street Address</label>
	                        <input value="" type="text" v-model="fields.street_address" id="street_address" class="form-control" v-bind:class="hasErrors('street_address') ? 'is-invalid' : ''">
	                    ...
	                    <div class="form-group col-md-3 px-2">
	                        ...
	                        <input value="" type="text" v-model="fields.barangay_address" id="barangay_address" class="form-control" v-bind:class="hasErrors('barangay_address') ? 'is-invalid' : ''">
	                        <div class="invalid-feedback" v-if="hasErrors('barangay_address')">
	                ...
	                <div class="row px-3">
	                    <div class="form-group col-md-4">
	                        ...
	                        <input value="" type="text" v-model="fields.city_address" id="city_address" class="form-control" v-bind:class="hasErrors('city_address') ? 'is-invalid' : ''">
	                    ...
	                    <div class="form-group col-md-4">
	                        ...
	                        <input value="" type="text" v-model="fields.province_address" id="province_address" class="form-control" v-bind:class="hasErrors('province_address') ? 'is-invalid' : ''">
	                    ...
	                    <div class="form-group col-md-4 px-2">
	                        ...
	                        <input value="" type="text" v-mask="masks.zipcode" v-model="fields.zipcode" id="zipcode" class="form-control" v-bind:class="hasErrors('zipcode') ? 'is-invalid' : ''">
				...
				<section class="px-2" v-if="step == 2">
						<h3 class="mb-3 ml-3 text-3xl title">Business Information</h3>	
	                    <div class="row px-3">
		                    <div class="col-12 px-3"> 
		                        <div class="text-2xl business" v-for="(item, key) in fields.businesses" :key="item.id">
		                            ...
		                            <div class="d-inline-block w-100">
			                            ...
			                            <button type="button" class="mr-0 btn btn-sm btn-danger float-right" @click="removeBusiness(key)">X</button>
		                            </div>
		                            <div class="row px-3">
		                                <div class="form-group col-md-12 px-0">
		                                    <label :for="'business_address_'+key">Full Business Address </label>
		                                    <input :id="'business_address_'+key" type="text" v-model="fields.businesses[key].business_address" class="form-control" v-bind:class="hasBusinessesError(key,'business_address') ? 'is-invalid' : ''">
				...
				<section class="px-2" v-if="step == 3">
					<h3 class="px-3 title text-3xl">Family Information</h3>	
					<div class="row px-3">
	                    <div class="form-group px-3 col-md-3">
	                        <label for="number_of_dependents">No. of dependents</label>
	                        <input value="" type="text" v-mask="masks.dependents" v-model="fields.number_of_dependents" id="number_of_dependents" class="form-control" v-bind:class="hasErrors('number_of_dependents') ? 'is-invalid' : ''">
	                    ...
	                    <div class="form-group px-3 col-md-3">
	                        ...
	                        <input type="text" v-mask="masks.household_size" v-model="fields.household_size" id="household_size" class="form-control" v-bind:class="hasErrors('household_size') ? 'is-invalid' : ''">
	                    ...
	                    <div class="form-group px-3 col-md-3">
	                        ...
	                        <input type="text" v-mask="masks.years_of_stay_on_house" v-model="fields.years_of_stay_on_house" id="years_of_stay_on_house" class="form-control" v-bind:class="hasErrors('years_of_stay_on_house') ? 'is-invalid' : ''">
	                ...
	                <div class="row px-3">
	                    <div class="form-group col-md-6">
	                        ...
	                        <input value="" type="text" v-model="fields.spouse_name" class="form-control" id="spouse_name" v-bind:class="hasErrors('spouse_name') ? 'is-invalid' : ''">
	                    ...
	                    <div class="form-group col-md-6">
	                        ...
	                        <input value="" type="text" v-mask="masks.phone" v-model="fields.spouse_contact_number" class="form-control" id="spouse_contact_number" v-bind:class="hasErrors('spouse_contact_number') ? 'is-invalid' : ''" placeholder="09XXXXXXXXX">
	                ...
	                <hr>
	                <h3 class="title text-3xl px-3 my-4">Statutories</h3>
	                ...
	                <div class="row px-3">
	                    ...
	                    <div class="form-group col-md-4">
	                        <label>UMID</label>
	                        <input value="" type="text" v-mask="masks.umid" v-model="fields.umid" id="umid" v-bind:class="hasErrors('umidHasError') ? 'is-invalid' : ''" class="form-control">
	                        <div class="invalid-feedback" v-if="hasErrors('umidHasError')">
	                            {{ errors.umid[0]}}
	                        </div>
	                    </div>
	                    <div class="form-group col-md-6 col-md-offset-6">
	                        <label>Mothers Maiden Name</label>
	                        <input value="" type="text" v-model="fields.mother_maiden_name" v-bind:class="hasErrors('mother_maiden_name') ? 'is-invalid' : ''" id="mother_maiden_name" class="form-control">
	                        <div class="invalid-feedback" v-if="hasErrors('mother_maiden_name')">
				...
				<section class="px-2" v-if="step == 4">
					<h3 class="px-3 title text-3xl">Household Income</h3>
	                <div class="row px-3">
	                ...
	                <div class="row px-3 my-3">
	                    <div class="form-group col-md-4 col-md-offset-8">
	                        ...
	                        <input type="text" class="form-control" v-bind:class="hasErrors('total_household_income') ? 'is-invalid' : ''"  readonly="true" :value="displayed_total_household_income">
	                        <div class="invalid-feedback" v-if="hasErrors('total_household_income')">
				...
				<div class="btn-container p-4 overflow-auto">

<template>
	<div class="card">
		...
		<div class="card-header">
			<h1 class="title text-2xl">Edit Deposit Product</h1>
		</div>
		<div class="card-body">
				...
				<div class="col-lg-8">
					...
					<div class="row mt-4">
						...
						<div class="form-group col-lg-2">
							...
							<input type="text" class="form-control text-xl" placeholder="%" id="interest_rate" v-model="fields.interest_rate" v-bind:class="interestRateHasError ? 'is-invalid' : ''" v-bind:has-error="interestRateHasError ? 'is-invalid' : ''">
					...
					<div class="row mt-4">
						<div class="form-group col-lg-6 d-inline-block">
							...
							<input type="number" class="form-control text-xl" id="deposit_portfolio" v-model="fields.deposit_portfolio" v-bind:class="depositPortfolioHasError ? 'is-invalid' : ''" v-bind:has-error="depositPortfolioHasError ? 'is-invalid' : ''">
...
<script>
	export default{
		...
		mounted(){
			var vm = this
			// var depositInfo = JSON.parse(this.deposit);
			$.each(this.deposit,function(k,v){
				vm.fields[k] = v
			})
		},
		methods:{
	        ...
	        submit(){
	        	axios.put('/settings/deposit/edit/'+this.deposit.id, this.fields)
                .then(res=>{
